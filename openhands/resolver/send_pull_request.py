...
PR_SIGNATURE = 'Automatic fix generated by [OpenHands](https://github.com/All-Hands-AI/OpenHands/) 🙌'
...
def send_pull_request(
    ...
    """Send a pull request to a GitHub, GitLab, Bitbucket, or Forgejo repository.
